...
const cardData = [
  {
    ...
    description: 'Deep insights into Projects',
    label: 'Analytics'
  },
  {
    color: '#060010',
    title: 'Unified Dashboard',
    description: 'Visualize all your data in one interactive view.',
    label: 'Dashboard'
  },
  {
    color: '#060010',
    title: 'Real Time Collaboration',
    description: 'Collaborate live with your entire team anywhere.',
    label: 'Collab'
  },
  {
    color: '#060010',
              ...
              return (
                <ParticleCard
                  ...
                  <div className="card__content flex flex-col relative text-white">
                    <h3
                      className={`card__title font-normal font-FT text-base m-0 mb-1 ${textAutoHide ? 'text-clamp-1' : ''}`}>
                      {card.title}
                    </h3>
                    <p
                      className={`card__description text-xs font-HG tracking-wider text-justify leading-5 opacity-90 ${textAutoHide ? 'text-clamp-2' : ''}`}>
                      {card.description}
                    </p>
                  </div>
                </ParticleCard>
                ...
                <div className="card__header flex justify-between items-center gap-3 relative text-white font-JBM px-3 py-2">
                  ...
                  <span className="inline-flex items-center justify-center w-6 h-6 rounded-full bg-white/10 border border-white/30 shadow-md">
                    <svg width="18" height="18" viewBox="0 0 20 20" fill="none">
                      ...
                      <circle cx="10" cy="10" r="3" fill="rgba(132,0,255,0.25)"/>
                    </svg>
                  </span>
                </div>
                <div className="card__content flex flex-col relative text-white px-3 pb-2 pt-1">
                  <h3
                    className={`card__title font-semibold text-lg m-0 mb-1 tracking-tight leading-tight ${textAutoHide ? 'text-clamp-1' : ''}`}>
                    <span className="inline-block align-middle mr-1">
                      <svg className="inline-block" width="18" height="18" viewBox="0 0 18 18" fill="none">
                        <circle cx="9" cy="9" r="8" stroke="rgba(255,255,255,0.12)" strokeWidth="2"/>
                        <circle cx="9" cy="9" r="3" fill="rgba(132,0,255,0.15)"/>
                      </svg>
                    </span>
                    {card.title}
                  </h3>
                  <p
                    className={`card__description text-xs md:text-sm leading-5 opacity-90 ${textAutoHide ? 'text-clamp-2' : ''}`}>
                    {card.description}
                  </p>
                  <div className="flex mt-2 space-x-2">
                    ...
                    <span className="inline-flex items-center px-2.5 py-0.5 rounded-md bg-white/10 text-xs text-white font-normal border border-white/20">
                      Extra
                    </span>
                  </div>
                </div>
