          ...
          <Card>
            <CardHeader className="text-center">
              ...
              <CardDescription className="font-HG tracking-wide sm:text-sm text-xs">
                Enter your workspace details below. Workspace helps you organize
                your projects.
              </CardDescription>
            </CardHeader>
            <CardContent>
            ...
            <div className="flex-1 flex flex-col justify-end min-h-0">
              <div className="relative rounded-xl bg-gradient-to-br from-blue-100 via-white to-blue-200 dark:from-gray-800 dark:via-gray-900 dark:to-gray-800 border border-blue-300 dark:border-gray-600 overflow-hidden px-4 py-4 h-full">
                ...
                <p className="text-xs text-blue-700 leading-normal text-justify font-HG dark:text-amber-50">
                  A{" "}
                  <span className="font-semibold text-black bg-pink-100 px-1 rounded">
                    workspace
                  </span>{" "}
                  is your team’s private area for projects and collaboration.
                  ...
                  <span
                    ...
                    style={{
                      background:
                        "linear-gradient(90deg, #dbeafe 0%, #bae6fd 100%)",
                      color: "#1e293b",
                  ...
                  Set a clear{" "}
                  <span className="text-blue-800 font-semibold dark:text-teal-200">
                    name
                  </span>{" "}
                  ,{" "}
                  <span className="text-blue-800 font-semibold dark:text-red-200">
                    code
                  </span>{" "}
                  and{" "}
                  <span className="text-blue-800 font-semibold dark:text-purple-200">
                    description
                  </span>{" "}
                  to make your workspace instantly recognizable for everyone.
