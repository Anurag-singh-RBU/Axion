...
const SectionCard = ({ title, description, children }) => (
  <div className="w-full sm:p-6 px-3 rounded-lg shadow-md">
    <h2 className="text-xl md:text-2xl font-bold text-white mb-2 font-JBM">
      {title}
    </h2>
    <p className="text-sm sm:text-md text-gray-400 mb-3 font-HG text-justify">
      {description}
    </p>
            ...
            >
              <div className="sm:space-y-2 space-y-4 relative z-10 tracking-wider bg-linear-to-br from-gray-900/90 to-black/90 backdrop-blur-xl border border-gray-800 rounded-2xl p-6 shadow-2xl">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="font-bold font-JBM text-white text-lg mb-0">
                    Content
                  </h3>
                </div>
                ...
                <div className="flex items-center sm:text-sm text-xs">
                  <span className="text-gray-400">
                    Automate task tracking and improve project visibility.
                  </span>
                </div>
                ...
                <div className="flex items-start gap-3 sm:text-sm text-xs">
                  <span className="text-gray-400">
                    Track dependencies across multiple tasks and projects.
                  </span>
                </div>
              </div>
            </SectionCard>
                ...
                <div className="relative z-10 bg-linear-to-br from-gray-900/90 to-black/90 backdrop-blur-xl border border-gray-800 rounded-2xl p-6 shadow-2xl">
                  <div className="font-mono text-sm text-gray-300 space-y-1">
                    ...
                    <div className="mt-3 text-xs space-y-1">
                      <div className="text-gray-400 font-HG tracking-wider">
                        mcpservers : {"{"}
                      </div>
                      <div className="ml-4 text-gray-300 font-HG tracking-wider">
                        linear : {"{"}
                      </div>
                      <div className="ml-8 mb-3">
                        <span className="text-blue-400 font-HG tracking-wider">
                          command
                        </span>
                        <span className="text-gray-500"> : </span>
                        <span className="text-green-400 font-HG tracking-wider">
                          pnpm
                        </span>
                      </div>
