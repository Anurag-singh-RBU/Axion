                        ...
                        <div className="flex flex-col gap-y-2">
                          <div className="flex items-center gap-x-5">
                            ...
                            <div className="flex flex-col justify-center">
                              ...
                              ) : <Button type="button" variant="outline" size="sm" className="w-fit sm:mt-2 px-3 py-2 rounded-md bg-white border border-neutral-300 hover:bg-neutral-50 text-neutral-900 transition-colors duration-150"
                                onClick={() => {
      ...
      {current && (
        <>
          <button
            ...
            <ChevronDown
              className={`h-4 w-4 text-gray-400 group-hover:text-gray-600 transition-transform ${isOpen ? "rotate-180" : ""
                }`} />
          </button>
                    ...
                    {recent.map((ws) => {
                      ...
                      return (
                        <button
                          ...
                          className={`flex w-full items-center justify-between rounded-md px-1.5 py-1.5 text-left text-[12px] transition-colors group ${isSelected
